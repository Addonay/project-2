...
try:
    ...
    question6 = Question(question='Which investment pportfolio would you prefer?')
    ...
    session.add_all([user1, user2, profile1, profile2, question1, question2, question3, question4, question5, question6,
                     question7, question8, question9, question10, question11, question12, question13, question14,
                      ...
                      attempt1, attempt2])
    session.commit()
    response1 = Response(user_id=user1.user_id, choice_id=choice1.id, question_id=question1.id, attempt_id=attempt1.id)
    response2 = Response(user_id=user1.user_id, choice_id=choice4.id, question_id=question2.id, attempt_id=attempt1.id)
    response3 = Response(user_id=user2.user_id, choice_id=choice2.id, question_id=question1.id, attempt_id=attempt2.id)
    response4 = Response(user_id=user2.user_id, choice_id=choice3.id, question_id=question2.id, attempt_id=attempt2.id)

    session.add_all([response1, response2, response3, response4])
    session.commit()
